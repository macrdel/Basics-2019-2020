...
procedure RecEasyIterations (f: func; x0: real; e: real; var x: real; var n: integer); 
procedure Secant (f: func; x1, x2: real; e: real; var x: real; var n: integer);
procedure RecSecant (f: func; x1, x2: real; e: real; var x: real; var n: integer);
procedure Newton (f: func; x0: real; e: real; var x: real; var n: integer);
procedure RecNewton (f: func; x0: real; e: real; var x: real; var n: integer);
